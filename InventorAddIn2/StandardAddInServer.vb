...
Namespace SureshAddIn
    <ProgIdAttribute("InventorAddIn2.StandardAddInServer"),
    GuidAttribute("c4ac11d2-d0ea-4b1c-ad31-f5351715367d")>
    Public Class StandardAddInServer
        Implements Inventor.ApplicationAddInServer

        Private WithEvents m_uiEvents As UserInterfaceEvents
        Private WithEvents m_sampleButton As ButtonDefinition
        Private WithEvents My_Assembly_Button As ButtonDefinition
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            ...
            Dim largeIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.ICON)
            Dim smallIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.ICON)
            Dim AssemblyIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.AssemblyIcon)
            Dim controlDefs As Inventor.ControlDefinitions = g_inventorApplication.CommandManager.ControlDefinitions
            m_sampleButton = controlDefs.AddButtonDefinition("Fixture Block", "Internal Name", CommandTypesEnum.kShapeEditCmdType, AddInClientID, StandardIcon:=largeIcon, LargeIcon:=largeIcon)
            My_Assembly_Button = controlDefs.AddButtonDefinition("Assemble Coupling", "CouplingAssembly", CommandTypesEnum.kShapeEditCmdType, AddInClientID, StandardIcon:=AssemblyIcon, LargeIcon:=AssemblyIcon)
...
#Region "User interface definition"
        ...
        Private Sub AddToUserInterface()
            ...
            Dim ZeroDocRibben As Ribbon = g_inventorApplication.UserInterfaceManager.Ribbons.Item("ZeroDoc")

            ' Get the "Tools" tab.
            Dim toolsTab As RibbonTab = ZeroDocRibben.RibbonTabs.Add("PartAutomation", "MY Customization", "id_Customization")

            ' Create a new panel.
            Dim customPanel As RibbonPanel = toolsTab.RibbonPanels.Add("Part Automation", "MysSample", AddInClientID)

            ' Add a button.
            customPanel.CommandControls.AddButton(m_sampleButton, True)
            'customPanel.CommandControls.AddButton(My_Assembly_Button, True)
        End Sub
        ...
        Private Sub m_sampleButton_OnExecute(Context As NameValueMap) Handles m_sampleButton.OnExecute
            Dim Myuserform As clsUserForm = New clsUserForm
            Myuserform.ShowDialog()
        End Sub

        ' Assembly Buttom handler 
        Private Sub My_Assembly_Button_OnExcecute(Context As NameValueMap) Handles My_Assembly_Button.OnExecute
            Dim MyAssembly As clsAssembly = New clsAssembly
            MyAssembly.AssembleCoupling()
        End Sub
#End Region
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(SureshAddIn.StandardAddInServer)
